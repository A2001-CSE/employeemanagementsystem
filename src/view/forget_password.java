...
public class forget_password extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/announcing.png"))); // NOI18N
        jLabel2.setText("\n");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals(jPasswordField1.getText())){
            boolean b = service.forget_password.fpassword(jTextField2.getText(),jPasswordField1.getText());
            if(b){
